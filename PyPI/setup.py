...
setup(
    ...
    version=VERSION,
    author="hackwithakki",
    author_email="hackwithakki@gmail.com",
    description=DESCRIPTION,
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    packages=find_packages(),
    url="https://github.com/hackwithakki/Facad1ng",
    Homepage="https://github.com/hackwithakki/Facad1ng",
    Repository="https://github.com/hackwithakki/Facad1ng",
    license="MIT",
