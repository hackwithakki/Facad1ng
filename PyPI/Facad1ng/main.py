...
twitter_url = 'https://x.com/Hackwithakki'
discord = 'https://discord.com/channels/hackwithakki'
instagram = 'https://www.instagram.com/hackwithakki/'
blog = 'https://hackwithakki.blog/'
github = 'https://github.com/hackwithakki/Facad1ng'
...
def print_banners():
    ...
    print(f'{G}╰➤ {C}Creator      : {W}{Hackwithakki}')
